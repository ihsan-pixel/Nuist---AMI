                ...
                <div>
                    <div class="grid gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input id="app_name" name="app_name" form="app-setting-form" value="{{ old('app_name', $settings['app_name']->value ?? config('app.name')) }}" class="mt-2 block w-full rounded-2xl border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-[#00553F] focus:ring-[#00553F]">
                        ...
                        <div>
                            ...
                            <input id="app_version" name="app_version" form="app-setting-form" value="{{ old('app_version', $settings['app_version']->value ?? '1.0.0') }}" class="mt-2 block w-full rounded-2xl border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-[#00553F] focus:ring-[#00553F]">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input id="app_tagline" name="app_tagline" form="app-setting-form" value="{{ old('app_tagline', $settings['app_tagline']->value ?? 'Audit Mutu Internal') }}" class="mt-2 block w-full rounded-2xl border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-[#00553F] focus:ring-[#00553F]">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input id="app_organization" name="app_organization" form="app-setting-form" value="{{ old('app_organization', $settings['app_organization']->value ?? 'NUIST') }}" class="mt-2 block w-full rounded-2xl border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-[#00553F] focus:ring-[#00553F]">
                        ...
                        <div>
                            ...
                            <input id="app_support_email" name="app_support_email" type="email" form="app-setting-form" value="{{ old('app_support_email', $settings['app_support_email']->value ?? '') }}" class="mt-2 block w-full rounded-2xl border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-[#00553F] focus:ring-[#00553F]">
                        ...
                        <div>
                            ...
                            <input id="app_website" name="app_website" type="url" form="app-setting-form" value="{{ old('app_website', $settings['app_website']->value ?? '') }}" class="mt-2 block w-full rounded-2xl border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-[#00553F] focus:ring-[#00553F]">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input id="app_copyright" name="app_copyright" form="app-setting-form" value="{{ old('app_copyright', $settings['app_copyright']->value ?? '© '.date('Y').' NUIST') }}" class="mt-2 block w-full rounded-2xl border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-[#00553F] focus:ring-[#00553F]">
                            @error('app_copyright') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                    </div>

                    <form id="app-setting-form" method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data" class="mt-6 space-y-4">
                        @csrf
